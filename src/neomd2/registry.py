"""The extension rack of neomd2 (v2 migration plan §2, B skeleton).
...
The registry is the *only* global mutable state in neomd2 and it is append
...
def scan_entry_points() -> list[str]:
    """Discover and load plugins declaring the ``neomd2`` entry-point group.
