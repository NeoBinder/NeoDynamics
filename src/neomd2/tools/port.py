...
neomd2 talks to external executables (AmberTools antechamber/parmchk2 today,
...
class ToolRunner(ABC):
    ...
    def run(
        ...
        *,
        ...
        managed = None
        if cwd is None:
            managed = tempfile.TemporaryDirectory(prefix="neomd2-tool-")
...
class ChargeBackend(Protocol):
    ...
    Returns array-like floats in *elementary charge* — neomd2's internal
