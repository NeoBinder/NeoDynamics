...
neomd2.colvars evaluate conventions; ``group_energy(groups)`` — per-force-
...
class FakeKernel:
    ...
    def bias_values(self, positions: np.ndarray | None = None) -> dict[str, float]:
        ...
        neomd2.colvars conventions); keys are bias labels (falling back to
    ...
    def restore(self, data: bytes) -> None:
        ...
        if payload.get("format") != "neomd2-fake-kernel-v1":
